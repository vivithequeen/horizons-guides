...
description: How to make a basic godot platformer!
---

In this guide, you'll build a 2D platformer game with a character that can run and jump around. You will use [Godot](https://godotengine.org/), a free and open source game engine that is super easy to learn. By the end (~100 mins), you'll have a working platformer you can customize and share!
...
You can run your game now with ctrl/cmd+b or the play button. It works, but the template code is the minimum and we can improve it to make the movement better. First, it is important to understand the template code! Read through:
...
### Change Player, Background, and Tileset
...
- **Collectibles** - Create coins, gems, or power-ups that the player can collect. Use Area2D nodes and signals to detect when the player touches them. [This](https://www.youtube.com/watch?v=Rh_8UXjYTn4) is a useful video.
...
Once you're done building your game, it's time to upload it online so other people can play it! [Itch.io](https://itch.io/) is a popular platform where games are shared.
...
*This guide was originally written by Estella Gu for [Jumpstart](https://jams.hackclub.com/jam/godot-platformer).*
